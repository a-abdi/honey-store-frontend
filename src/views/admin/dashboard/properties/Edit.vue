<template>
    <form>
        <div v-if="propertyData" class="px-1 sm:space-y-12 sm:pb-8 sm:mb-8 mt-6 mx-auto 2xl:w-4/12 xl:w-5/12 lg:w-6/12 md:w-8/12 sm:w-full border border-gray-200 rounded-md">
